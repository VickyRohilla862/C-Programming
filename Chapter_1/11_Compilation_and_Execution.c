...
// A C program is written in plain text. This plain text is combination of instructons in a particular sequence. The compiler perform some basic checks and finally converts the program into an executable.